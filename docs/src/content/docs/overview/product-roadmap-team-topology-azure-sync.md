---
title: "Product Roadmap: Team Topologies + Azure Sync"
---
...
5. Detailed execution plan and architecture baseline: `docs/src/content/docs/architecture/adr/008-rig-agent-platform-orchestration.md`.
6. Task-level implementation backlog: [`Rig Agent Task Breakdown`](../opy/rig-agent-task-breakdown.md).
