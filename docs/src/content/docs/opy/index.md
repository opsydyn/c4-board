...
- `src/core/effects/opy-board-context.ts`
...
- [Rig agent platform orchestration ADR](../architecture/adr/008-rig-agent-platform-orchestration.md)
- [Rig agent task breakdown](rig-agent-task-breakdown.md)
