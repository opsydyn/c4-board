				...
				<div onClick={(e) => e.stopPropagation()}>
					...
					<Form onSubmit={handleSubmit}>
						...
						<div className={edgeEditorField}>
							<Label className={edgeEditorLabel}>Protocol</Label>
							<select
								className={edgeEditorInput}
								value={protocol ?? ""}
								onChange={(e) =>
									setProtocol(
										(e.target.value as EdgeProtocol) || undefined,
									)
								}
							>
						...
						<div className={edgeEditorField}>
							<Label className={edgeEditorLabel}>Communication Style</Label>
							<select
								className={edgeEditorInput}
								value={communicationStyle}
								onChange={(e) =>
									setCommunicationStyle(
										e.target.value as EdgeCommunicationStyle,
									)
								}
							>
						...
						{/* Animation Speed */}
						<div className={edgeEditorField}>
							<Label className={edgeEditorLabel}>Animation Speed</Label>
							<select
								className={edgeEditorInput}
								value={animationSpeed}
								onChange={(e) =>
									setAnimationSpeed(e.target.value as EdgeAnimationSpeed)
								}
							>
