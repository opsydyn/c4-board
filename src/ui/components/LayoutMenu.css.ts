...
/**
 * Shared Tactical Select Controls
 * Single source of truth for dropdown styling across the app.
 */
export const menuSelectContainer = style({
  "@layer": {
    [componentsLayer]: {
      position: "relative",
      width: "100%",
...
export const menuSelectShell = style({
  "@layer": {
    [componentsLayer]: {
      position: "relative",
      display: "flex",
...
export const menuSelectPopover = style({
  "@layer": {
    [componentsLayer]: {
      position: "fixed",
...
export const menuSelectList = style({
  "@layer": {
    [componentsLayer]: {
      margin: 0,
      padding: theme.spacing["2"],
...
export const menuSelectOption = style({
  "@layer": {
    [componentsLayer]: {
      display: "flex",
      alignItems: "center",
...
export const menuSelectOptionIcon = style({
  "@layer": {
    [componentsLayer]: {
      flexShrink: 0,
      color: theme.color.status.selected,
...
export const menuSelectLeadIcon = style({
  "@layer": {
    [componentsLayer]: {
      position: "static",
      display: "inline-flex",
...
export const menuSelectChevronIcon = style({
  "@layer": {
    [componentsLayer]: {
      position: "absolute",
      zIndex: 1,
