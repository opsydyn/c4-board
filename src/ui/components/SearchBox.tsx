...
import { getNodeTypeColor, getNodeTypeLabel, searchNodes, type SearchResult } from "../../core/effects/search";
import {
  emptyState,
  kbd,
  resultBadge,
                ...
                return (
                  ...
                  >
                    ...
                    <div className={resultContent}>
                      ...
                      {description && <div className={resultDescription}>{description}</div>}
                    </div>
                  </div>
                );
              })
