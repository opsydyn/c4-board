...
function KeyboardPlugin({
  ...
  useEffect(() => {
    ...
    const removeEnterCommand = mode === "plain"
    ...
    const removeRichEnterCommand = mode === "rich"
      ? editor.registerCommand(
        KEY_ENTER_COMMAND,
        (event) => {
    ...
    >
      <LexicalComposer initialConfig={initialConfig}>
        {mode === "plain"
          ? (
            <PlainTextPlugin
              contentEditable={<ContentEditable className={inlineEditorContentEditable} />}
              placeholder={<div className={inlineEditorPlaceholder}>{placeholder}</div>}
