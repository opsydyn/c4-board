...
import { Brand, Data, DateTime, Duration, Schema } from "effect";
 ...
 */
export const isHttpMethod = (s: string): s is HttpMethod => Schema.is(HttpMethodSchema)(s);
 ...
 */
export const fromEpochMillis = (millis: number): UtcDateTime => DateTime.unsafeMake(millis);

/**
 * Convert DateTime to epoch milliseconds (for database storage)
 */
export const toEpochMillis = (dt: UtcDateTime): number => DateTime.toEpochMillis(dt);

/**
 * Create Duration from milliseconds
 */
export const durationFromMillis = (millis: number): TimeDuration => Duration.millis(millis);

/**
 * Convert Duration to milliseconds
 */
export const durationToMillis = (duration: TimeDuration): number => Duration.toMillis(duration);

/**
 * Create Duration from seconds
 */
export const fromSeconds = (seconds: number): TimeDuration => Duration.seconds(seconds);

/**
 * Create Duration from minutes
 */
export const fromMinutes = (minutes: number): TimeDuration => Duration.minutes(minutes);
