...
import { highlightMatches, parseJsonLines, searchJsonContent } from "./json-search";
...
describe("searchJsonContent", () => {
  ...
  it("should find exact matches", () => {
    ...
    const hasAlice = results.some((r) => r.line.trimmedContent.toLowerCase().includes("alice"));
