...
export const exportC4ToMermaidC4 = (
  ...
  Effect.succeed((() => {
    ...
    const lines: string[] = [
      ...
      "%% Element layout is not preserved: Mermaid C4 positions shapes by statement order.",
      "%% Export the Flowchart dialect instead to re-import this board with its layout.",
    ];
