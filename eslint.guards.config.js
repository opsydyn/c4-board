...
const c4OrchestrationHookMatcher = "^useC4(?:Commands|Autosave|Navigation)Machine$";
  ...
  tseslint.configs.recommended,
  {
    ...
    rules: {
      ...
      "no-restricted-syntax": [
        ...
        {
          selector:
            `CallExpression[callee.name=/${c4OrchestrationHookMatcher}/] > ObjectExpression > Property[value.type=/^(ArrowFunctionExpression|FunctionExpression)$/]`,
          message:
