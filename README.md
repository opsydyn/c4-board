...
Full handbook: [docs/opy/README.md](docs/opy/README.md)
...
Roadmap: [docs/product-roadmap-team-topology-azure-sync.md](docs/product-roadmap-team-topology-azure-sync.md)
...
Release install notes: [docs/release-installation.md](docs/release-installation.md)

Apple signing and notarization notes: [.github/apple-signing.md](.github/apple-signing.md)

## macOS Unsigned Build Workaround

Signed and notarized releases should open normally. For local unsigned test builds, macOS may block launch with "developer cannot be verified". See [docs/release-installation.md](docs/release-installation.md) for the safe local workaround.
...
- [OPY handbook](docs/opy/README.md)
- [Rig agent task breakdown](docs/rig-agent-task-breakdown.md)
- [Rig hello-world boundary](docs/rig-agent-hello-world.md)
- [Product roadmap](docs/product-roadmap-team-topology-azure-sync.md)
- [Release installation](docs/release-installation.md)
- [ADR index](docs/adr/README.md)
- [Context menu implementation](docs/CONTEXT_MENU_IMPLEMENTATION.md)
- [Postmortem: OPY board interaction regression](docs/postmortems/2026-06-05-opy-native-board-interaction-regression.md)
...
docs/                     Architecture, roadmap, release, OPY, ADRs
